...
public class AuthController {
    ...
    public ResponseEntity<NotifGuiaCreadoDTO> registerGuia(@RequestBody GuiaDTO guiaDto) {
    ...
    public ResponseEntity<NotifTuristaCreadoDTO> registerTurista(@RequestBody TuristaDTO turistaDTO) {
        TuristaEntity turista = turistaMapper.mapFrom(turistaDTO);
        TuristaEntity turistaEntityGuardado = authenticationService.registrarTurista(turista);
