...
GenericDAO<T> {
    ...
    public int getLastInsertId(String field) throws Exception { //Modified (LFF)
        ...
        try {
            ...
            if (last != "") {
                ...
                index = jsonObject.get(field).toString();
            }
    ...
    public boolean delete(int id, String field) throws Exception { //Modified (LFF)
        ...
        try {
            ...
            while ((line = b.readLine()) != null) {
                JsonObject jsonObject = parser.parse(line).getAsJsonObject();
                if (Integer.parseInt(jsonObject.get(field).toString()) != id) {
    ...
    public boolean delete(String id, String field) throws Exception { //Modified (LFF)
        boolean wasDeleted = false;
        try {
            BufferedReader b = new BufferedReader(new FileReader(archivo));
            StringBuffer inputBuffer = new StringBuffer();
            ...
            while ((line = b.readLine()) != null) {
                JsonObject jsonObject = parser.parse(line).getAsJsonObject();
                if (!Objects.equals(jsonObject.get(field).toString(), id)) {
                    inputBuffer.append(line);
                    inputBuffer.append('\n');
                } else {
                    wasDeleted = true;
    ...
    public boolean deleteAll(List<Integer> id, String field) throws Exception { //Modified (LFF)
        boolean wasDeleted = false;
        try {
            BufferedReader b = new BufferedReader(new FileReader(archivo));
            StringBuffer inputBuffer = new StringBuffer();
            ...
            while ((line = b.readLine()) != null) {
                JsonObject jsonObject = parser.parse(line).getAsJsonObject();
                int jsonField = Integer.parseInt(jsonObject.get(field).toString());
                if (!id.contains(jsonField)) {
                    inputBuffer.append(line);
                    inputBuffer.append('\n');
                } else {
                    wasDeleted = true;
